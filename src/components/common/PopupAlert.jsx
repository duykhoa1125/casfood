...
import { WarningCircle, CheckCircle, Info, XCircle, Question, X } from '@phosphor-icons/react';
...
export default function PopupAlert({
  ...
  let icon = <WarningCircle size={32} weight="duotone" style={{ color: 'var(--accent-orange)' }} />;
  let badgeBg = 'rgba(249, 115, 22, 0.15)';
  let borderColor = 'rgba(249, 115, 22, 0.3)';
  let defaultTitle = 'Thông báo';

  if (type === 'error') {
    icon = <XCircle size={32} weight="duotone" style={{ color: '#ef4444' }} />;
    badgeBg = 'rgba(239, 68, 68, 0.15)';
    borderColor = 'rgba(239, 68, 68, 0.3)';
    defaultTitle = 'Có lỗi xảy ra';
  } else if (type === 'success') {
    icon = <CheckCircle size={32} weight="duotone" style={{ color: 'var(--accent-green)' }} />;
    badgeBg = 'rgba(34, 197, 94, 0.15)';
    borderColor = 'rgba(34, 197, 94, 0.3)';
    defaultTitle = 'Thành công!';
  } else if (type === 'info') {
    icon = <Info size={32} weight="duotone" style={{ color: 'var(--accent-color)' }} />;
    badgeBg = 'rgba(56, 189, 248, 0.15)';
    borderColor = 'rgba(56, 189, 248, 0.3)';
    defaultTitle = 'Thông báo';
  } else if (type === 'confirm') {
    icon = <Question size={32} weight="duotone" style={{ color: 'var(--accent-purple)' }} />;
