...
import { Utensils, ShieldCheck, Users, ChevronRight, RotateCcw } from 'lucide-react';

function generateAdminSlug() {
  // Generate 16-char hex slug — effectively unguessable
      ...
      <div style={{ width: '100%', maxWidth: '380px' }}>
        ...
        {step === 'role' && (
          <div className="glass-card" style={{ padding: '20px' }}>
            ...
            >
              <Users size={22} style={{ color: 'var(--text-muted)', flexShrink: 0 }} />
              <div style={{ flex: 1 }}>
                <div style={{ fontWeight: '700', fontSize: '13px', color: 'var(--text-main)' }}>Tôi là người đặt món</div>
                <div style={{ fontSize: '11px', color: 'var(--text-muted)', marginTop: '2px' }}>
                  Nhận link từ người gom đơn để đặt
                </div>
              </div>
            </div>

            <p style={{ color: 'var(--text-muted)', fontSize: '10px', textAlign: 'center', marginTop: '14px' }}>
              Đồng nghiệp dùng link riêng từ người gom đơn để truy cập
            </p>
          </div>
        )}
